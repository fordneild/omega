...
type ApplicationSetSpecGeneratorsClustersTemplateSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSetSpecGeneratorsClustersTemplateSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecGeneratorsClustersTemplateSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
