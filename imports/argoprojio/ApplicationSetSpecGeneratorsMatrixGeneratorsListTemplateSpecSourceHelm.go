...
type ApplicationSetSpecGeneratorsMatrixGeneratorsListTemplateSpecSourceHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsListTemplateSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsListTemplateSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
