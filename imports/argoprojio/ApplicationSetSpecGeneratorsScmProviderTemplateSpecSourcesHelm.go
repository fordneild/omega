...
type ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourcesHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourcesHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourcesHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
