...
type ApplicationSetSpecGeneratorsMatrixGeneratorsClustersTemplateSpecSourceHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsClustersTemplateSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsClustersTemplateSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
