...
type ApplicationSetSpecGeneratorsMergeGeneratorsListTemplateSpecSourceHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsMergeGeneratorsListTemplateSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsMergeGeneratorsListTemplateSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
