...
type ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourceHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
