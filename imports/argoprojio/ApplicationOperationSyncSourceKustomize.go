...
type ApplicationOperationSyncSourceKustomize struct {
	...
	Patches *[]*ApplicationOperationSyncSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	// Replicas is a list of Kustomize Replicas override specifications.
	Replicas *[]*ApplicationOperationSyncSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
