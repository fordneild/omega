...
type ApplicationSetSpecGeneratorsMatrixGeneratorsClusterDecisionResourceTemplateSpecSourceHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsClusterDecisionResourceTemplateSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsClusterDecisionResourceTemplateSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
