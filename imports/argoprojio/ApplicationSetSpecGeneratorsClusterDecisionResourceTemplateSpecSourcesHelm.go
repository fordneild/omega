...
type ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourcesHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourcesHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourcesHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
