...
type ApplicationSetSpecGeneratorsPullRequestTemplateSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSetSpecGeneratorsPullRequestTemplateSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecGeneratorsPullRequestTemplateSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
