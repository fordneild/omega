...
type ApplicationSetSpecGeneratorsPluginTemplateSpecSourceHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsPluginTemplateSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsPluginTemplateSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
