...
type ApplicationSpecSourceHelm struct {
	...
	FileParameters *[]*ApplicationSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
