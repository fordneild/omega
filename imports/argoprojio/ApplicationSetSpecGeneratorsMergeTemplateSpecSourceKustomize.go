...
type ApplicationSetSpecGeneratorsMergeTemplateSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSetSpecGeneratorsMergeTemplateSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecGeneratorsMergeTemplateSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
