...
type ApplicationSpecSourcesHelm struct {
	...
	FileParameters *[]*ApplicationSpecSourcesHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSpecSourcesHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
