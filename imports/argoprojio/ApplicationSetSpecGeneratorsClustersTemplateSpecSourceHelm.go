...
type ApplicationSetSpecGeneratorsClustersTemplateSpecSourceHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsClustersTemplateSpecSourceHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsClustersTemplateSpecSourceHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
