...
type ApplicationSetSpecTemplateSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSetSpecTemplateSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecTemplateSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
