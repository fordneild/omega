...
type ApplicationSetSpecGeneratorsMatrixGeneratorsPluginTemplateSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsPluginTemplateSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecGeneratorsMatrixGeneratorsPluginTemplateSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
