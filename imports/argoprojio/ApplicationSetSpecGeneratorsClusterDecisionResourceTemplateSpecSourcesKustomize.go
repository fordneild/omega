...
type ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourcesKustomize struct {
	...
	Patches *[]*ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourcesKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourcesKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
