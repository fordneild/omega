...
type ApplicationSetSpecGeneratorsClustersTemplateSpecSourcesHelm struct {
	ApiVersions *[]*string `field:"optional" json:"apiVersions" yaml:"apiVersions"`
	FileParameters *[]*ApplicationSetSpecGeneratorsClustersTemplateSpecSourcesHelmFileParameters `field:"optional" json:"fileParameters" yaml:"fileParameters"`
	...
	Parameters *[]*ApplicationSetSpecGeneratorsClustersTemplateSpecSourcesHelmParameters `field:"optional" json:"parameters" yaml:"parameters"`
