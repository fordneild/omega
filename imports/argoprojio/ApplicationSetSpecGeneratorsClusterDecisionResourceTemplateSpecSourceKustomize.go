...
type ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecGeneratorsClusterDecisionResourceTemplateSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
