...
type ApplicationSpecSourcesKustomize struct {
	...
	Patches *[]*ApplicationSpecSourcesKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	// Replicas is a list of Kustomize Replicas override specifications.
	Replicas *[]*ApplicationSpecSourcesKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
