...
type ApplicationSetSpecTemplateSpecSourcesKustomize struct {
	...
	Patches *[]*ApplicationSetSpecTemplateSpecSourcesKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecTemplateSpecSourcesKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
