...
type ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	Replicas *[]*ApplicationSetSpecGeneratorsScmProviderTemplateSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
