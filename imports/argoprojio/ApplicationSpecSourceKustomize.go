...
type ApplicationSpecSourceKustomize struct {
	...
	Patches *[]*ApplicationSpecSourceKustomizePatches `field:"optional" json:"patches" yaml:"patches"`
	// Replicas is a list of Kustomize Replicas override specifications.
	Replicas *[]*ApplicationSpecSourceKustomizeReplicas `field:"optional" json:"replicas" yaml:"replicas"`
